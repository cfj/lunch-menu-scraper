...
function meck() {
    return new _promise2['default'](function (resolve, reject) {
        var url = _config2['default'].meck.url;
        var restaurant = {};

        restaurant.menu = [];
        restaurant.url = url;
        restaurant.mapUrl = _config2['default'].meck.mapUrl;
        restaurant.name = _config2['default'].meck.name;

        (0, _scraper2['default'])(url, _config2['default'].meck.scraperSelector, function (week) {
            for (var i = 0; i < 5; i++) {
...
function plectrum() {
    return new _promise2['default'](function (resolve, reject) {
        var url = _config2['default'].plectrum.url;
        var restaurant = {};

        restaurant.menu = [];
        restaurant.url = url;
        restaurant.mapUrl = _config2['default'].plectrum.mapUrl;
        restaurant.name = _config2['default'].plectrum.name;

        (0, _scraper2['default'])(url, _config2['default'].plectrum.scraperSelector, function (week) {
            for (var i = 0; i < 5; i++) {
